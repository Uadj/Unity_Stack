...
public class PerfectController : MonoBehaviour
{
    ...
    {
        //Vector3 positioin = cubeSpawner.LastCube.position;
        //positioin.y = cubeSpawner.CurrentCube.transform.position.y - cubeSpawner.CurrentCube.transform.localScale.y * 0.5f;
